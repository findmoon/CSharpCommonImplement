...
{
    /// <summary>
    /// 原名LongDirectory。可处理LongPath的Directory操作
    /// </summary>
    public class Directory
    {
        private const int MAX_PATH = 248;// 260;
        ...
        private static void DeleteDirectories(string[] directories)
        {
            ...
            {
                string[] files = Directory.GetFiles(directory, null, System.IO.SearchOption.TopDirectoryOnly);
                foreach (string file in files)
                {
                    File.Delete(file);
                }
                directories = Directory.GetDirectories(directory, null, System.IO.SearchOption.TopDirectoryOnly);
        ...
        public static string[] GetFiles(string path, string searchPattern, System.IO.SearchOption searchOption)
        {
            ...
            if (searchOption == SearchOption.AllDirectories)
            {
                ...
                dirs.AddRange(Directory.GetDirectories(path, null, SearchOption.AllDirectories));
            }
