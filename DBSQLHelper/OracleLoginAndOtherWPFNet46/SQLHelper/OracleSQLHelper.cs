...
namespace System.Data
{
    ...
    public class OracleSQLHelper : ISQLHelper, IDisposable
    {
        ...
        public static OracleSQLHelper WindowsAuthentication(string dbName, string ipServer= "localhost", ushort? port = null)
        {
            ...
            oraHelper.Initializer($"User Id=/;Data Source={dbName};");
            //oraHelper.Initializer($"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST={ipServer})(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME={dbName})));user id=/;");
