...
namespace SQLHelperForCompact
{
    /// <summary>
    /// The SqlHelper class is intended to encapsulate high performance, 
    /// scalable best practices for common uses of SqlClient.
    /// </summary>
    public abstract class SqlHelperCE
    {
        //Database connection strings
        public static readonly string ConnStrMain = "";
        //public static readonly string ConnStrMain = pubclass.pubc.cstr;
        ...
        private static void PrepareCommand(SqlCeCommand command, DbConnection connection, SqlCeTransaction transaction, CommandType commandType, string commandText, SqlCeParameter[] commandParameters, out bool mustCloseConnection)
        {
            if (command == null) throw new ArgumentNullException("command");
        ...
        private static SqlCeDataReader ExecuteReader(SqlCeConnection connection, SqlCeTransaction transaction, CommandType commandType, string commandText, SqlCeParameter[] commandParameters, SqlConnectionOwnership connectionOwnership)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        public static SqlCeDataReader ExecuteReader(SqlCeConnection connection, CommandType commandType, string commandText, params SqlCeParameter[] commandParameters)
        {
            ...
            return ExecuteReader(connection, (SqlCeTransaction)null, commandType, commandText, commandParameters, SqlConnectionOwnership.External);
        }
        ...
        public static SqlCeDataReader ExecuteReader(SqlCeTransaction transaction, CommandType commandType, string commandText, params SqlCeParameter[] commandParameters)
        {
            ...
            return ExecuteReader((SqlCeConnection)transaction.Connection, transaction, commandType, commandText, commandParameters, SqlConnectionOwnership.External);
        }
        ...
        /// <returns>数据表的行数</returns>
        public static int GetTableCount(string sql)
        {
            int ret = 0;
            DataSet ds = ExecuteDataset(ConnStrMain, CommandType.Text, sql);
