namespace HelperCollectionsUse
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "HelperCollections使用测试（IISHelper的测试参见 IISManipulate 项目）";
            // 
            // groupBox1
            // 
            ...
            this.button1.Text = "写入.url文本，File、链接 快捷方式";
