...
{
    [Obsolete("请使用ButtonPro，测试Graphics.FillRegion 填充Region同样有锯齿，忽略使用")]
    public class ButtonPro2 : Button
    {
        ...
        /// 圆形按钮的半径属性
        /// </summary>
        [CategoryAttribute("Layout"), DefaultValue(20), Description("圆角半径，>=0时启用圆角按钮，等于0为直角(但可使用背景色等所有Round圆角相关属性)，<0时使用默认Button样式")]
        ...
        /// 是否启用创建新Region的模式
        /// </summary>
        [CategoryAttribute("Layout"), DefaultValue(false), Description("创建新Region的模式，使用'绘制范围'创建新的Region，实现控件区域贴合绘制范围，实现'正确的透明'，但相对会有些的锯齿")]
        ...
        /// 三角尖角位置，当启用圆角
        /// </summary>
        [CategoryAttribute("Layout"), Description("(三角)尖角的显示位置，当启用圆角按钮(RoundRadius>=0)，且显示尖角时有效"), DefaultValue(RectangleAlign.RightTop)]
        ...
        [CategoryAttribute("Layout"), Description("是否显示尖角，默认不显示，当启用Radius圆角(RoundRadius>=0)时才有效"), DefaultValue(false)]
        ...
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "0, 0, 0"), Description("启用Radius圆角(RoundRadius>=0)时边框颜色，默认黑色")]
        ...
        /// </summary>
        [CategoryAttribute("Appearance"), DefaultValue(false), Description("启用渐变背景色(需要RoundRadius>=0)，启用后RoundNormalColor、RoundHoverColor、RoundPressedColor颜色无效")]
        ...
        /// 线性渐变的模式，默认垂直渐变
        /// </summary>
        [CategoryAttribute("Appearance"), DefaultValue(LinearGradientMode.Vertical), Description("线性渐变的模式，默认垂直渐变")]
        ...
        /// 背景渐变色
        /// </summary>
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "90, 143, 0"), Description("渐变开始色")]
        ...
        /// 背景渐变色
        /// </summary>
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "41, 67, 0"), Description("渐变结束色")]
        ...
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "51, 161, 224"), Description("启用Radius圆角(RoundRadius>=0)时按钮标准颜色")]
        ...
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "220, 80, 80"), Description("启用Radius圆角(RoundRadius>=0)鼠标位于按钮上时的按钮颜色")]
        ...
        [CategoryAttribute("Appearance"), DefaultValue(typeof(Color), "251, 161, 0"), Description("启用Radius圆角(RoundRadius>=0)鼠标按下时的按钮颜色")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (roundRadius >= 0)
            {
                ...
                if (enableBGGradient)
                {
                    ...
                    rect = e.Graphics.DrawFillRoundRectAndCusp(controlRect, roundRadius, beginBGColor, endBGColor, showCusp, CuspAlign, gradientModel, roundBorderSize > 0 ? new Pen(roundBorderColor, roundBorderSize) : null);
                }
                else
                {
                    Color baseColor;
                    ...
                    if (regionNewModel)
                    {
                        e.Graphics.FillRegion(Region, baseColor);
                    }
                    else
                    {
                        //rect = e.Graphics.DrawFillRoundRectAndCusp(e.ClipRectangle, roundRadius, baseColor, showCusp, cuspAlign);
                        rect = e.Graphics.DrawFillRoundRectAndCusp(controlRect, roundRadius, baseColor, showCusp, cuspAlign, roundBorderSize > 0 ? new Pen(roundBorderColor, roundBorderSize) : null);
                        // 使用合适的区域
