...
public static class EncryptUtil
{
    ...
    #region Base64加密解密
    /// <summary>
    /// Default 编码的 Base64加密
    /// </summary>
    /// <param name="value">待加密文本</param>
    /// <returns></returns>
    [Obsolete("使用的Default编码，推荐utf8编码的Base64扩展方法")]
    ...
    /// <summary>
    /// Default 编码的 Base64解密
    /// </summary>
    /// <param name="ciphervalue">密文</param>
    /// <returns></returns>
    [Obsolete("使用的Default编码，推荐utf8编码的UnBase64扩展方法")]
    ...
    [Obsolete("方法似乎不对，待确认。Substring(0, 16)？",true)]
