...
> 此部分主要参考自 [数据库最强辅助工具SQL Prompt 最新版安装和激活](https://www.cnblogs.com/StrakiChen/p/13204015.html)
...
> ILSpy 的 Visual Studio 插件，目前没有 VS2022 的版本。

ILSpy 几乎是 .NET 下唯一的一个开源的反编译工具，开源协议MIT。
